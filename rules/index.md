...
- [data.md](data.md) — self-hosted MySQL/Redis account model, MySQL schema/pool/error mapping, Redis ACL quirks, key layout and TTLs, expiry, the kv and leaderboard tables and the state account's table-scoped grant.
